...
while (ii<Nsamp)
    ...
    b(ii+1,10) = S10(1,1)*a(ii+1,10)+S10(1,2)*a(ii+1,11)+S10(1,3)*a(ii+1,12);
    ...
    a(ii+1,2) = b(ii+1,4);
    a(ii+1,27) = b(ii+1,28);
    b(ii+1,25) = S25(1,1)*a(ii+1,25)+S25(1,2)*a(ii+1,26)+S25(1,3)*a(ii+1,27);
    ...
    b(ii+1,27) = S25(3,1)*a(ii+1,25)+S25(3,2)*a(ii+1,26)+S25(3,3)*a(ii+1,27);
